...
const Table2 = (props: UsersTable) => {
    ...
    const qrActionColumn = useMemo(() => {
        return {
            accessor: 'qrAction',
            title: 'Action For QR Code',
            titleClassName: '!text-center',
            sortable: false,
            render: (v: any, index: number) => {
                return;
    ...
    const compiledColumns = useMemo(() => {
        ...
        // change render of qrAction column
    ...
    return (
        <>
            ...
            <div className={` ${className} h-full flex-col  flex-grow col-span-12 md:col-span-12 flex my-0 py-0 `}>
                <div className="pb-3 w-full flex flex-col flex-grow h-full overflow-hidden">
                    <div className=" p-6 py-3 border-b flex justify-between items-center">
                        ...
                        <button
                            ...
                            className="bg-brand-600 text-white p-2 rounded-lg text-sm"
                        >
                            Create
                        </button>
                    </div>
                        ...
                        <>
                            <div className="px-5 py-2 ">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className=" flex gap-4">
                                        <button className={`${fetching && !loading ? 'animate-spin' : ''}`} onClick={refetch}>
                            ...
                            <div className="datatables">
                                <DataTable
                                    ...
                                    highlightOnHover
                                    className={`${fetching && !loading ? ' animate-pulse pointer-events-none ' : ''}  whitespace-nowrap ${props.handleRowClick ? '' : 'table-cursor-auto'}`}
                                    records={recordsData}
